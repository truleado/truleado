...
// Simple Zoho contact creation function using API
async function createZohoContact(email: string, fullName: string) {
  try {
    console.log('🔗 Creating Zoho contact for:', email)
    ...
    if (result.success) {
      console.log('✅ Zoho contact created successfully:', result.contactId)
    } else {
      console.warn('❌ Zoho contact creation failed:', result.error)
    }
  } catch (error) {
    console.warn('❌ Zoho contact creation error:', error)
  }
}
