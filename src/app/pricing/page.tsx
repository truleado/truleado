        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600 max-w-3xl mx-auto">
              Start with a free trial to see how Truleado can help you find your next customers on Reddit.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="mt-16 max-w-3xl mx-auto">
            <div className="space-y-8">
              <div>
                ...
                <p className="mt-2 text-gray-600">
                  You get full access to all features for 1 day. No credit card required to start. If you don't cancel, you'll be charged $30/month after the trial ends.
                </p>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-blue-100 max-w-2xl mx-auto">
              Start your free trial today and see how Truleado can help you find quality leads on Reddit.
            </p>
            <div className="mt-8">
              <Link 
                href="/auth/signup" 
