    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 font-medium">{t.freeTrial.cta}</p>
        </div>
      </div>
    );
  }
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-600 mb-6 sm:mb-8 max-w-4xl mx-auto leading-relaxed px-4">
              {t.hero.description}
              <span className="font-semibold text-gray-800"> {t.hero.noCommitment}</span>
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 max-w-6xl mx-auto">
            ...
            <div className="bg-white rounded-2xl sm:rounded-3xl shadow-xl border border-gray-200 p-6 sm:p-8 hover:shadow-2xl transition-shadow duration-300">
              <div className="text-center">
                <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2">{t.freeTrial.title}</h3>
                <p className="text-sm sm:text-base text-gray-600 mb-6 sm:mb-8">{t.freeTrial.subtitle}</p>
                
                <div className="mb-6 sm:mb-8">
                  <div className="flex items-baseline justify-center">
                    <span className="text-4xl sm:text-5xl font-bold text-gray-900">{t.freeTrial.price}</span>
                    <span className="text-lg sm:text-xl text-gray-500 ml-2">{t.freeTrial.period}</span>
                  </div>
                  <p className="mt-2 text-xs sm:text-sm text-gray-600">{t.freeTrial.noCreditCard}</p>
                </div>
              ...
              <div className="mt-6 sm:mt-8 border-t border-gray-200 pt-6 sm:pt-8">
                <h4 className="text-base sm:text-lg font-semibold text-gray-900 mb-4 sm:mb-6">{t.freeTrial.includedTitle}</h4>
                <ul className="space-y-3 sm:space-y-4">
                  <li className="flex items-start">
                    ...
                    <span className="text-sm sm:text-base text-gray-700">{t.freeTrial.item1}</span>
                  </li>
                  <li className="flex items-start">
                    <div className="w-5 h-5 sm:w-6 sm:h-6 bg-green-100 rounded-full flex items-center justify-center mr-3 mt-0.5">
                      <Check className="h-3 w-3 sm:h-4 sm:w-4 text-green-600" />
                    </div>
                    <span className="text-sm sm:text-base text-gray-700">{t.freeTrial.item2}</span>
                  </li>
                  <li className="flex items-start">
                    <div className="w-5 h-5 sm:w-6 sm:h-6 bg-green-100 rounded-full flex items-center justify-center mr-3 mt-0.5">
                      <Check className="h-3 w-3 sm:h-4 sm:w-4 text-green-600" />
                    </div>
                    <span className="text-sm sm:text-base text-gray-700">{t.freeTrial.item3}</span>
                  </li>
                  <li className="flex items-start">
                    <div className="w-5 h-5 sm:w-6 sm:h-6 bg-green-100 rounded-full flex items-center justify-center mr-3 mt-0.5">
                      <Check className="h-3 w-3 sm:h-4 sm:w-4 text-green-600" />
                    </div>
                    <span className="text-sm sm:text-base text-gray-700">{t.freeTrial.item4}</span>
                  </li>
                  <li className="flex items-start">
                    <div className="w-5 h-5 sm:w-6 sm:h-6 bg-green-100 rounded-full flex items-center justify-center mr-3 mt-0.5">
                      <Check className="h-3 w-3 sm:h-4 sm:w-4 text-green-600" />
                    </div>
                    <span className="text-sm sm:text-base text-gray-700">{t.freeTrial.item5}</span>
                  </li>
                  <li className="flex items-start">
                    <div className="w-5 h-5 sm:w-6 sm:h-6 bg-green-100 rounded-full flex items-center justify-center mr-3 mt-0.5">
                      <Check className="h-3 w-3 sm:h-4 sm:w-4 text-green-600" />
                    </div>
                    <span className="text-sm sm:text-base text-gray-700">{t.freeTrial.item6}</span>
                  </li>
                  <li className="flex items-start">
                    <div className="w-5 h-5 sm:w-6 sm:h-6 bg-green-100 rounded-full flex items-center justify-center mr-3 mt-0.5">
                      <Check className="h-3 w-3 sm:h-4 sm:w-4 text-green-600" />
                    </div>
                    <span className="text-sm sm:text-base text-gray-700">{t.freeTrial.item7}</span>
                  </li>
                  <li className="flex items-start">
                    <div className="w-5 h-5 sm:w-6 sm:h-6 bg-green-100 rounded-full flex items-center justify-center mr-3 mt-0.5">
                      <Check className="h-3 w-3 sm:h-4 sm:w-4 text-green-600" />
                    </div>
                    <span className="text-sm sm:text-base text-gray-700">{t.freeTrial.item8}</span>
                  </li>
                  <li className="flex items-start">
                    <div className="w-5 h-5 sm:w-6 sm:h-6 bg-green-100 rounded-full flex items-center justify-center mr-3 mt-0.5">
                      <Check className="h-3 w-3 sm:h-4 sm:w-4 text-green-600" />
                    </div>
                    <span className="text-sm sm:text-base text-gray-700">{t.freeTrial.item9}</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl sm:rounded-3xl shadow-2xl border-2 border-blue-200 p-6 sm:p-8 relative hover:shadow-3xl transition-shadow duration-300">
              ...
              <div className="text-center">
                <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2">{t.proPlan.title}</h3>
                <p className="text-sm sm:text-base text-gray-600 mb-6 sm:mb-8">{t.proPlan.subtitle}</p>
                
                <div className="mb-6 sm:mb-8">
                  <div className="flex items-baseline justify-center">
                    <span className="text-4xl sm:text-5xl font-bold text-gray-900">{t.proPlan.price}</span>
                    <span className="text-lg sm:text-xl text-gray-500 ml-2">{t.proPlan.period}</span>
                  </div>
                  <p className="mt-2 text-xs sm:text-sm text-gray-600">{t.proPlan.description}</p>
                </div>
              ...
              <div className="mt-8 border-t border-gray-200 pt-8">
                <h4 className="text-lg font-semibold text-gray-900 mb-6">{t.proPlan.includedTitle}</h4>
                <ul className="space-y-4">
                  <li className="flex items-start">
                    <div className="w-5 h-5 sm:w-6 sm:h-6 bg-green-100 rounded-full flex items-center justify-center mr-3 mt-0.5">
                      <Check className="h-3 w-3 sm:h-4 sm:w-4 text-green-600" />
                    </div>
                    <span className="text-sm sm:text-base text-gray-700">{t.proPlan.item1}</span>
                  </li>
                  <li className="flex items-start">
                    <div className="w-5 h-5 sm:w-6 sm:h-6 bg-green-100 rounded-full flex items-center justify-center mr-3 mt-0.5">
                      <Check className="h-3 w-3 sm:h-4 sm:w-4 text-green-600" />
                    </div>
                    <span className="text-sm sm:text-base text-gray-700">{t.proPlan.item2}</span>
                  </li>
                  <li className="flex items-start">
                    <div className="w-5 h-5 sm:w-6 sm:h-6 bg-green-100 rounded-full flex items-center justify-center mr-3 mt-0.5">
                      <Check className="h-3 w-3 sm:h-4 sm:w-4 text-green-600" />
                    </div>
                    <span className="text-sm sm:text-base text-gray-700">{t.proPlan.item3}</span>
                  </li>
                  <li className="flex items-start">
                    <div className="w-5 h-5 sm:w-6 sm:h-6 bg-green-100 rounded-full flex items-center justify-center mr-3 mt-0.5">
                      <Check className="h-3 w-3 sm:h-4 sm:w-4 text-green-600" />
                    </div>
                    <span className="text-sm sm:text-base text-gray-700">{t.proPlan.item4}</span>
                  </li>
                  <li className="flex items-start">
                    <div className="w-5 h-5 sm:w-6 sm:h-6 bg-green-100 rounded-full flex items-center justify-center mr-3 mt-0.5">
                      <Check className="h-3 w-3 sm:h-4 sm:w-4 text-green-600" />
                    </div>
                    <span className="text-sm sm:text-base text-gray-700">{t.proPlan.item5}</span>
                  </li>
                  <li className="flex items-start">
                    <div className="w-5 h-5 sm:w-6 sm:h-6 bg-green-100 rounded-full flex items-center justify-center mr-3 mt-0.5">
                      <Check className="h-3 w-3 sm:h-4 sm:w-4 text-green-600" />
                    </div>
                    <span className="text-sm sm:text-base text-gray-700">{t.proPlan.item6}</span>
                  </li>
                  <li className="flex items-start">
                    <div className="w-5 h-5 sm:w-6 sm:h-6 bg-green-100 rounded-full flex items-center justify-center mr-3 mt-0.5">
                      <Check className="h-3 w-3 sm:h-4 sm:w-4 text-green-600" />
                    </div>
                    <span className="text-sm sm:text-base text-gray-700">{t.proPlan.item7}</span>
                  </li>
                  <li className="flex items-start">
                    <div className="w-5 h-5 sm:w-6 sm:h-6 bg-green-100 rounded-full flex items-center justify-center mr-3 mt-0.5">
                      <Check className="h-3 w-3 sm:h-4 sm:w-4 text-green-600" />
                    </div>
                    <span className="text-sm sm:text-base text-gray-700">{t.proPlan.item8}</span>
                  </li>
                  <li className="flex items-start">
                    <div className="w-5 h-5 sm:w-6 sm:h-6 bg-green-100 rounded-full flex items-center justify-center mr-3 mt-0.5">
                      <Check className="h-3 w-3 sm:h-4 sm:w-4 text-green-600" />
                    </div>
                    <span className="text-sm sm:text-base text-gray-700">{t.proPlan.item9}</span>
                  </li>
                </ul>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center group">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4">{t.features.feature1Title}</h3>
            ...
            <div className="text-center group">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4">{t.features.feature2Title}</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            <div className="text-center group">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4">{t.features.feature3Title}</h3>
              <p className="text-gray-600 leading-relaxed">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-gray-50 rounded-2xl p-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-3">{t.faq.q1Title}</h3>
                <p className="text-gray-600 leading-relaxed">
                  {t.faq.q1Desc}
                </p>
              </div>
              ...
              <div className="bg-gray-50 rounded-2xl p-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-3">{t.faq.q2Title}</h3>
                <p className="text-gray-600 leading-relaxed">
                  {t.faq.q2Desc}
                </p>
              </div>
              ...
              <div className="bg-gray-50 rounded-2xl p-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-3">{t.faq.q3Title}</h3>
                <p className="text-gray-600 leading-relaxed">
                  {t.faq.q3Desc}
                </p>
              </div>
              ...
              <div className="bg-gray-50 rounded-2xl p-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-3">{t.faq.q4Title}</h3>
                <p className="text-gray-600 leading-relaxed">
                  {t.faq.q4Desc}
                </p>
              </div>
            ...
            <div className="flex flex-col md:flex-row justify-between items-center">
              <div className="text-center md:text-left">
                <p className="text-gray-400 text-sm mb-2">
                  {t.footer.madeWith} <span className="text-yellow-400">☕</span> {t.footer.onEarth} <span className="text-blue-400">🌍</span>
                </p>
